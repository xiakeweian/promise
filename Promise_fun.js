...
(function (window) {
  ...
  */
  Promise.prototype.then = function (onResolved, onRejected) {
    //指定回调函数的默认值(必须是函数)
    onResolved = typeof onResolved === 'function' ? onResolved : value => value;//向后传递 成功的value
  ...
  Promise.all = function (promises) {
    ...
    return new Promise((resolve, reject) => {
      ...
      promises.forEach((p, index) => {
        ...
        Promise.resolve(p).then(value => {//p成功对话，将成功对value保存到values中
          resolveCount++;
          values[index] = value
